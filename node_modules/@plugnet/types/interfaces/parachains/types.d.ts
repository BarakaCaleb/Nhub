...
/** u32 */
export declare type AuctionIndex = u32;
/** [AccountId, u64] & Codec */
export declare type BalanceUpload = [AccountId, u64] & Codec;
/** Enum */
...
/** Signature */
export declare type CollatorSignature = Signature;
/** [ParaId, Hash] & Codec */
export declare type EgressQueueRoot = [ParaId, Hash] & Codec;
/** Bytes */
export declare type HeadData = Bytes;
/** Enum */
...
/** BlockNumber */
export declare type LeasePeriod = BlockNumber;
/** LeasePeriod */
export declare type LeasePeriodOf = LeasePeriod;
/** Struct */
...
/** u32 */
export declare type ParaId = u32;
/** ParaId */
export declare type ParaIdOf = ParaId;
/** Enum */
...
/** u32 */
export declare type ValidatorIndex = u32;
/** Enum */
...
export declare type ValidityVote = [ValidatorIndex, ValidityAttestation] & Codec;
/** Vec<WinningDataEntry> */
export declare type WinningData = Vec<WinningDataEntry>;
/** [AccountId, ParaIdOf, BalanceOf] & Codec */
export declare type WinningDataEntry = [AccountId, ParaIdOf, BalanceOf] & Codec;
