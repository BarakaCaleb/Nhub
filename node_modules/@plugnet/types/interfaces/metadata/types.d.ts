...
/** DoubleMapTypeV5 */
export declare type DoubleMapTypeV6 = DoubleMapTypeV5;
/** DoubleMapTypeV6 */
export declare type DoubleMapTypeV7 = DoubleMapTypeV6;
/** Struct */
...
/** EventMetadataV0 */
export declare type EventMetadataV1 = EventMetadataV0;
/** EventMetadataV1 */
export declare type EventMetadataV2 = EventMetadataV1;
/** EventMetadataV2 */
export declare type EventMetadataV3 = EventMetadataV2;
/** EventMetadataV3 */
export declare type EventMetadataV4 = EventMetadataV3;
/** EventMetadataV4 */
export declare type EventMetadataV5 = EventMetadataV4;
/** EventMetadataV5 */
export declare type EventMetadataV6 = EventMetadataV5;
/** EventMetadataV6 */
export declare type EventMetadataV7 = EventMetadataV6;
/** Struct */
...
export declare type FunctionArgumentMetadataV1 = FunctionArgumentMetadataV0;
/** FunctionArgumentMetadataV1 */
export declare type FunctionArgumentMetadataV2 = FunctionArgumentMetadataV1;
/** FunctionArgumentMetadataV2 */
export declare type FunctionArgumentMetadataV3 = FunctionArgumentMetadataV2;
/** FunctionArgumentMetadataV3 */
export declare type FunctionArgumentMetadataV4 = FunctionArgumentMetadataV3;
/** FunctionArgumentMetadataV4 */
export declare type FunctionArgumentMetadataV5 = FunctionArgumentMetadataV4;
/** FunctionArgumentMetadataV5 */
export declare type FunctionArgumentMetadataV6 = FunctionArgumentMetadataV5;
/** FunctionArgumentMetadataV6 */
export declare type FunctionArgumentMetadataV7 = FunctionArgumentMetadataV6;
/** Struct */
...
/** FunctionMetadataV1 */
export declare type FunctionMetadataV2 = FunctionMetadataV1;
/** FunctionMetadataV2 */
export declare type FunctionMetadataV3 = FunctionMetadataV2;
/** FunctionMetadataV3 */
export declare type FunctionMetadataV4 = FunctionMetadataV3;
/** FunctionMetadataV4 */
export declare type FunctionMetadataV5 = FunctionMetadataV4;
/** FunctionMetadataV5 */
export declare type FunctionMetadataV6 = FunctionMetadataV5;
/** FunctionMetadataV6 */
export declare type FunctionMetadataV7 = FunctionMetadataV6;
/** Struct */
...
/** MapTypeV2 */
export declare type MapTypeV3 = MapTypeV2;
/** Struct */
...
/** MapTypeV4 */
export declare type MapTypeV5 = MapTypeV4;
/** MapTypeV5 */
export declare type MapTypeV6 = MapTypeV5;
/** MapTypeV6 */
export declare type MapTypeV7 = MapTypeV6;
/** Struct */
...
export declare type ModuleConstantMetadataV7 = ModuleConstantMetadataV6;
/** Struct */
...
/** Vec<EventMetadataV0> */
export declare type OuterEventEventMetadataEventsV0 = Vec<EventMetadataV0>;
/** [Text, OuterEventEventMetadataEventsV0] & Codec */
export declare type OuterEventEventMetadataV0 = [Text, OuterEventEventMetadataEventsV0] & Codec;
/** Struct */
...
/** Type */
export declare type PlainTypeV0 = Type;
/** Type */
export declare type PlainTypeV2 = Type;
/** Type */
export declare type PlainTypeV3 = Type;
/** Type */
export declare type PlainTypeV4 = Type;
/** Type */
export declare type PlainTypeV5 = Type;
/** Type */
export declare type PlainTypeV6 = Type;
/** Type */
export declare type PlainTypeV7 = Type;
/** Struct */
...
export declare type StorageEntryModifierV6 = StorageFunctionModifierV5;
/** StorageEntryModifierV6 */
export declare type StorageEntryModifierV7 = StorageEntryModifierV6;
/** Struct */
...
export declare type StorageFunctionMetadataV1 = StorageFunctionMetadataV0;
/** Enum */
...
/** StorageFunctionModifierV0 */
export declare type StorageFunctionModifierV1 = StorageFunctionModifierV0;
/** StorageFunctionModifierV1 */
export declare type StorageFunctionModifierV2 = StorageFunctionModifierV1;
/** StorageFunctionModifierV2 */
export declare type StorageFunctionModifierV3 = StorageFunctionModifierV2;
/** StorageFunctionModifierV3 */
export declare type StorageFunctionModifierV4 = StorageFunctionModifierV3;
...
/** StorageFunctionTypeV0 */
export declare type StorageFunctionTypeV1 = StorageFunctionTypeV0;
/** Struct */
