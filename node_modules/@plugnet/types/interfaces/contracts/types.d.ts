...
/** Hash */
export declare type CodeHash = Hash;
/** Enum */
...
/** Uint8Array & Codec */
export declare type ContractStorageKey = Uint8Array & Codec;
/** u64 */
...
/** Option<Null> */
export declare type PrefabWasmModuleReserved = Option<Null>;
/** Struct */
...
/** Hash */
export declare type SeedOf = Hash;
/** Hash */
export declare type TombstoneContractInfo = Hash;
/** Bytes */
export declare type TrieId = Bytes;
