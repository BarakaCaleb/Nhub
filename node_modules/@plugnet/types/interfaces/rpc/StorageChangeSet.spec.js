...
describe('StorageChangeSet', () => {
  describe('construction', () => {
    const set = (0, _types.createType)('StorageChangeSet', {
      block: '0x1234',
      changes: [['0xab', '0xcd']]
    });
    it('wraps blockHash', () => {
  ...
  describe('json', () => {
    const set = (0, _types.createType)('StorageChangeSet', _StorageChangeSet.default.params.result);
    ...
    it('converts result data to Bytes', () => {
      const bytes = (0, _types.createType)('Bytes', set.changes[0][1].unwrap());
