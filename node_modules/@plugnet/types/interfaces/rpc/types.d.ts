...
/** Uint8Array & Codec */
export declare type ApiId = Uint8Array & Codec;
/** Struct */
...
export declare type KeyValueOption = [StorageKey, Option<StorageData>] & Codec;
/** Struct */
...
/** [ApiId, u32] & Codec */
export declare type RuntimeVersionApi = [ApiId, u32] & Codec;
/** Struct */
