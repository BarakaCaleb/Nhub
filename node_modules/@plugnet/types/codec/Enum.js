...
class Enum extends _Base.default {
  ...
  static decodeViaString(def, value) {
    return (0, _util.isHex)(value) ? Enum.decodeViaValue(def, (0, _util.hexToU8a)(value)) : Enum.createViaJSON(def, value);
  }
  ...
  toRawType() {
    const _enum = this._isBasic ? Object.keys(this._def) : _Struct.default.typesToMap(this._def);
