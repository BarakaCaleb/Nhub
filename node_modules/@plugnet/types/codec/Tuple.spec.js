...
describe('Tuple', () => {
  ...
  it.skip('creates properly via actual hex string', () => {
    ...
    const test = new (_Tuple.default.with([(0, _create.ClassOf)('BlockNumber'), (0, _create.ClassOf)('Proposal'), (0, _create.ClassOf)('VoteThreshold')]))('0x62190000000000000003507b0a092230783432223a202230783433220a7d0a01');
