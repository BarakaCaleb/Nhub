...
const infoMapping = {
  ...
  [_types.TypeDefInfo.Null]: value => (0, _createClass.ClassOf)('Null'),
  [_types.TypeDefInfo.Option]: value => _Option.default.with(getSubType(value)),
  [_types.TypeDefInfo.Plain]: value => {
    throw new Error("Unable to find plain type for ".concat(JSON.stringify(value)));
  },
