...
function _decodeStruct(value, type, subType) {
  ...
  value.info = _types.TypeDefInfo.Struct;
...
function _decodeFixedVec(value, type, subType) {
  ...
  value.info = _types.TypeDefInfo.VecFixed;
  value.ext = {
    length: vecLen,
    type: vecType
  };
...
function _decodeTuple(value, type, subType) {
  value.info = _types.TypeDefInfo.Tuple;
...
const nestedExtraction = [['[', ']', _decodeFixedVec], ['{', '}', _decodeStruct], ['(', ')', _decodeTuple]];
const wrappedExtraction = [['Compact<', '>', _types.TypeDefInfo.Compact], ['Option<', '>', _types.TypeDefInfo.Option], ['Vec<', '>', _types.TypeDefInfo.Vec], ['Linkage<', '>', _types.TypeDefInfo.Linkage], ['DoubleMap<', '>', _types.TypeDefInfo.DoubleMap]];
