...
describe('SignerPayload', () => {
  ...
  beforeEach(() => {
    _types.GenericCall.injectMethods(_static.default);
  });
  it('creates a valid JSON output', () => {
    expect(new _SignerPayload.default({
      ...
      genesisHash: '0xdcd1346701ca8396496e52aa2785b1748deb6db09551b72159dcb3e08991025b',
      method: (0, _types.createType)('Call', '0x0500ffd7568e5f0a7eda67a82691ff379ac4bba4f9c9b859fe779b5d46363b61ad2db9e56c'),
      nonce: 0x1234,
      tip: 0x5678,
      version: 3
    }).toPayload()).toEqual({
