...
var _static = _interopRequireDefault(require("@plugnet/api-metadata/extrinsics/static"));
...
describe('ExtrinsicV3', () => {
  beforeEach(() => {
    _Call.default.injectMethods(_static.default);
  });
  ...
  it('creates a signed extrinsic', () => {
    expect(new _Extrinsic.default(_static.default.balances.transfer(keyring.bob.publicKey, 6969)).sign(keyring.alice, {
      ...
      tip: 2
    }).toHex()).toEqual('0x' + 'ff' + 'd172a74cda4c865912c32ba0a80a57ae69abae410e5ccb59dee84e2f4432db4f' + '21de8ff3cae3ee72ced565ed5f79fd153dc84a3be9166b7904eecde8045ba59a' + 'd2f998cc970e59157f168ec762eea061f4930b5288f57a45a1c1911863860208' + '000408' + // era. nonce, tip
