...
class Address extends _Base.default {
  ...
  static decodeAddress(value) {
    if (value instanceof _AccountId.default || value instanceof _AccountIndex.default) {
      ...
      return (0, _create.createType)('AccountIndex', value);
    } else if (Array.isArray(value) || (0, _util.isHex)(value) || (0, _util.isU8a)(value)) {
      return Address.decodeU8a((0, _util.u8aToU8a)(value));
    }
  ...
  static decodeString(value) {
    ...
    return decoded.length === 32 ? (0, _create.createType)('AccountId', decoded) : (0, _create.createType)('AccountIndex', (0, _util.u8aToBn)(decoded, true));
  }
  ...
  static decodeU8a(value) {
    ...
    if (value.length === 32) {
      return (0, _create.createType)('AccountId', value);
    } else if (value[0] === 0xff) {
      return (0, _create.createType)('AccountId', value.subarray(1));
    }

    const [offset, length] = _AccountIndex.default.readLength(value);

    return (0, _create.createType)('AccountIndex', (0, _util.u8aToBn)(value.subarray(offset, offset + length), true));
  }
  /**
