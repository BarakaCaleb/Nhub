...
class Type extends _Text.default {
  ...
  static decodeType(value) {
    return Type._mappings.reduce((result, fn) => {
      return fn(result);
    }, value).trim();
  }
  /**
...
Type._mappings = [// alias <T::InherentOfflineReport as InherentOfflineReport>::Inherent -> InherentOfflineReport
...
Type._alias('grandpa::AuthorityId', 'AuthorityId'), // specific for SessionIndex (could make this session::, but be conservative)
...
Type._alias('exec::StorageKey', 'ContractStorageKey'), // Phantom
Type._alias('rstd::marker::PhantomData', 'PhantomData'), // flattens tuples with one value, `(AccountId)` -> `AccountId`
