...
class Bytes extends _U8a.default {
  ...
  static decodeBytes(value) {
    if (Array.isArray(value) || (0, _util.isString)(value)) {
      return Bytes.decodeBytesU8a(_Compact.default.addLengthPrefix((0, _util.u8aToU8a)(value)));
    } else if (value instanceof (0, _create.ClassOf)('StorageData')) {
      return Bytes.decodeBytesStorage(value);
    } else if (!(value instanceof _U8a.default) && (0, _util.isU8a)(value)) {
