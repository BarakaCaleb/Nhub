...
class ApiRx extends _base.default {
  ...
  constructor(options) {
    ...
    this._isReadyRx = (0, _rxjs.from)( // You can create an observable from an event, however my mind groks this form better
    new Promise(resolve => {
      super.on('ready', () => {
        resolve(this);
      });
  ...
  clone() {
    return new ApiRx(_objectSpread({}, this._options, {
      source: this
    }));
  }
