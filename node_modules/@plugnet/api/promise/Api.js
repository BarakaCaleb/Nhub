...
function promiseTracker(_resolve, _reject) {
  ...
  return {
    reject: error => {
      complete(_reject, error);
      return _rxjs.EMPTY;
    },
    resolve: value => {
      complete(_resolve, value);
    }
  };
}
/**
...
function decorateMethod(method, options) {
  ...
  return function () {
    ...
    return new Promise((resolve, reject) => {
      ...
      (0, _operators.catchError)(error => tracker.reject(error)), // upon the first result, resolve the with the unsub function
      (0, _operators.tap)(() => tracker.resolve(() => subscription.unsubscribe()))).subscribe(callback);
    }); // ???
  };
}
/**
...
class ApiPromise extends _base.default {
  ...
  clone() {
    return new ApiPromise(_objectSpread({}, this._options, {
      source: this
    }));
  }
  /**
