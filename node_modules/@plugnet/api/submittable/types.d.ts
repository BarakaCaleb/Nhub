...
export declare type SubmitableResultResult<ApiType> = ApiType extends 'rxjs' ? Observable<SubmittableResultImpl> : Promise<Hash>;
export declare type SubmitableResultSubscription<ApiType> = ApiType extends 'rxjs' ? Observable<SubmittableResultImpl> : Promise<() => void>;
