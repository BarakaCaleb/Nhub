...
class Submittable extends _Extrinsic {
  ...
  _getPrelimState(address, options) {
    ...
    (0, _util.isUndefined)(options.nonce) ? this._api.query.system.accountNonce(address) : (0, _rxjs.of)((0, _types.createType)('Index', options.nonce)), // if we have an era provided already or eraLength is <= 0 (immortal)
