...
function subscribeNewHeads(api) {
  return () => api.rpc.chain.subscribeNewHeads().pipe((0, _operators.switchMap)(header => (0, _rxjs.combineLatest)([(0, _rxjs.of)(header), // theoretically we could combine at the first call with session.validators(), however
