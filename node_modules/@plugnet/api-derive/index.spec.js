...
var _Api = _interopRequireDefault(require("@plugnet/api/rx/Api"));

var _mock = _interopRequireDefault(require("@plugnet/rpc-provider/mock"));
...
describe('derive', () => {
  describe('builtin', () => {
    ...
    testFunction(api)('elections', 'approvalsOf', []); // FIXME This one has an additional check which mock doesnt (yet) cater for
