...
function calcBalances(_ref) {
  let [accountId = (0, _types.createType)('AccountId'), bestNumber = (0, _types.createType)('Balance'), [freeBalance = (0, _types.createType)('Balance'), reservedBalance = (0, _types.createType)('Balance'), locks = [], vesting = new _types.Option((0, _types.ClassOf)('VestingSchedule'), null), accountNonce = (0, _types.createType)('Balance')]] = _ref;
  ...
  const availableBalance = (0, _util.bnMax)((0, _types.createType)('Balance'), vestedBalance.sub(lockedBalance));
  return {
    accountId,
    accountNonce,
    availableBalance,
