...
var _Storage = require("@plugnet/types/Metadata/v7/Storage");
...
function createKey(_ref5, rawKey, arg, hasher) {
  ...
  return _types.Compact.addLengthPrefix(hasher(key));
...
function extendLinkedMap(_ref7, storageFn, stringKey, hasher) {
  ...
  const headHash = new _types.U8a(hasher("head of ".concat(stringKey)));
  ...
  headFn.meta = new _Storage.StorageEntryMetadata({
    name,
    modifier: (0, _codec.createType)('StorageEntryModifierV7', 1),
    // required
    type: new _Storage.StorageEntryType((0, _codec.createType)('PlainTypeV7', type.asMap.key), 0),
    fallback: new _types.Bytes((0, _codec.createTypeUnsafe)(type.asMap.key.toString()).toHex()),
    documentation
  ...
  storageFn.headKey = new _types.StorageKey(headFn, {
