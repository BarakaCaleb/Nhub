import { FunctionMetadataV7 } from '@plugnet/types/interfaces';
 ...
 */
export default function createDescriptor(section: string, sectionIndex: number, methodIndex: number, callMetadata: FunctionMetadataV7): CallFunction;
